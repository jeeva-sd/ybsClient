...
import { setSearchText } from '../../action/youtube';
...
export default function PrimarySearchAppBar() {
    ...
    React.useEffect(() => {
        setVideoCount(videos && videos.length > 0 ? videos.length : 0);
    }, [videos]);
    ...
    const renderMobileMenu = (
        ...
        >
            <MenuItem>
                <div>
                    <IconButton size="large" aria-label="show 4 new mails" color="inherit" onClick={() => navigate('/youtube')}>
                ...
                <div>
                    <IconButton size="large" aria-label="show 4 new mails" color="inherit" onClick={() => navigate('/youtube')}>
                        <Badge badgeContent={postCount} color="error">
                            <PublicIcon />
                        </Badge>
                    </IconButton>
                    <span>Published</span>
                ...
                <Toolbar>
                    ...
                    <Box sx={{ display: { xs: 'none', md: 'flex' } }}>
                        ...
                        {user && user.isLoggedIn ?
                            <Avatar alt="Remy Sharp" src={user.imageUrl} className='user-avatar' />
                            :
                            <IconButton
                                size="large"
                                edge="end"
