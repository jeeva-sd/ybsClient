...
import { SET_VIDEO_REQUESTING, SET_YOUTUBE_VIDEOS, SET_SEARCH_TEXT, GET_SELECTED_VIDEO } from './action-creators';
...
export const getSelectedVideo = videoId => ({ type: GET_SELECTED_VIDEO, videoId });
